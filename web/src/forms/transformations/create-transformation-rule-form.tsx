...
interface CreateTransformationRuleFormProps {
  open: boolean;
  onClose: () => void;
}
...
export function CreateTransformationRuleForm({
  open,
  onClose,
}: CreateTransformationRuleFormProps) {
          ...
          >
            ...
            <div className="space-y-4 border-t pt-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-xs">
                  Dispatches containing any of these keywords will match this
                  rule
                </p>
              </div>
            </div>
            ...
            <form.Subscribe
              selector={(state) => [state.values.transformations]}
            >
                ...
                >
                  {(field) => (
                    <div className="space-y-4 border-t pt-4">
                      ...
                      <p className="text-muted-foreground text-sm">
                        Select which field transformations to apply when this
                        rule matches
                      </p>
                      ...
                      {selectedTransformations.length > 0 && (
                        <div className="text-muted-foreground text-sm">
                          Selected {selectedTransformations.length}{" "}
                          transformation
